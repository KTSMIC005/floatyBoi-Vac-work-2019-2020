# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 15:43:21 2019
...
def save_attachments(message, directory):
    for part in message.walk():
        ...
        #if (file_name==("google.png")):#change this name to the attachment name
        if (".sbd" in file_name):#change this name to the attachment name
            ...
            if payload:
                ...
                try:
                    ...
                    print('Could not store: {file} bad file name or path under {op_sys}.'.format(
                        file=file_path,
...
if __name__ == '__main__':
    ...
    recover(resumeFile)
    if 'Log Files' not in os.listdir(os.getcwd()):
        os.mkdir('Log Files')
    for msg in generate_mail_messages(user_name, password, resumeFile):
        save_attachments(msg, 'Log Files')
